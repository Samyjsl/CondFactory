...
<head>
    ...
    <title>Просмотр (Админ-панель)</title>
</head>
...
<body>
    ...
    <section id="item-table">
        ...
        <div class="container-list">
            ...
            <div class="container-list-column type_product" style="display:none;"></div>
        ...
        <div class="container-list-add">
            <div class="container-list-row">
                ...
                <button class="btn-show-table" data-modal="order_items">Таблица товары в заказах</button>
                ...
                <button class="btn-show-table" data-modal="type_product">Таблица тип изделий</button>
    ...
    <script src="js-admin/get-tables.js"></script>
</body>
